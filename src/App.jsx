...
let routers = createHashRouter([
  {path:'', element: <Layout/> , children: [
    ...
    {path: 'artidentity' , element: <ProtectedRoute><Artidentity/></ProtectedRoute>},
    {path: 'artcaption' , element: <ProtectedRoute><Artcaption/></ProtectedRoute> },
    {path: 'analysis' , element:<ProtectedRoute><Analysis/></ProtectedRoute>},
    {path: 'styleswap' , element: <ProtectedRoute><ArtStyleTransfer/></ProtectedRoute>},
