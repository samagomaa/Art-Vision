    ...
    if (file && file.type.startsWith("image/")) {
      ...
      try {
        const { data } = await axios.post(
          "https://image-g3epahfrhjghgpfs.switzerlandnorth-01.azurewebsites.net/api/Generation/generate-caption",
          formData,
          {
            headers: {
                ...
                <div className="col-md-6 d-flex">
                  <div className="h-100 w-100 d-flex flex-column justify-content-center">
                    ...
                    <div className="border border-2 border-white rounded-3 bg-secondary">
                      <p className="p-4 mb-0 text-white d-flex justify-content-between fw-bold">
                        {dataAnalysis.caption}{" "}
                      </p>
                    </div>
                    <button
