...
export default function Critique() {
    ...
    const handleDrop = async (e) => {
        ...
        if (file && file.type.startsWith('image/')) {
            ...
            try{
                const res = await axios.post('https://image-g3epahfrhjghgpfs.switzerlandnorth-01.azurewebsites.net/api/Prediction/predict-style-genre', formData , {
                    headers: {
    ...
    :<> {image? <div className='container'>
        ...
        <div className="col-md-12">
            ...
            <p className='fw-bold text-white mb-0 h3 ms-1'>Art Identity</p>
            </Link>
          </div>
        ...
        <div className="col-md-6 d-flex">
            ...
            <p className='fw-bold text-white h4 py-3'>Style & Genre:</p>
            <Link to="/help"><i className="fa-solid fa-circle-info" style={{color: "#ffffff"}}></i></Link>
            </div>
            <div className='border border-2 border-white'>
                <p className='p-2 mb-0 text-white d-flex justify-content-between fw-bold'> <span>Style :</span> {dataAnalysis.style || "not found"} </p>
            </div>
            <div className='border border-2 border-white mt-2'>
                <p className='p-2 mb-0 text-white d-flex justify-content-between fw-bold'> <span>Genre :</span> {dataAnalysis.genre || "not found"} </p>
            </div>
